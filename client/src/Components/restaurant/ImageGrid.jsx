    ...
    return (
        <>
            <div className="w-full h-60 rounded-lg md:hidden">
                <img src={props.images[0]} alt="restaurant image" className="w-full h-full object-cover rounded-lg" />
            </div>
            <div className="hidden w-full h-96 md:flex gap-1 ">
                ...
                <div className="w-1/6 h-full flex flex-col gap-1 overflow-hidden">
                    ...
                    <div className="w-full h-full relative">
                        <img src={props.images[4]} alt="restaurant image" className="w-full h-full object-cover rounded-lg" />
