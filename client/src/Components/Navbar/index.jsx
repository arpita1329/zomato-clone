...
const MediumNav = () => {
    return (
      <>
        <div className ="hidden gap-4 lg:gap-7 w-full items-center justify-between md:flex lg:w-3/4 lg:mx-36">
            ...
            <div className = "w-full bg-white shadow-md p-3 flex items-center gap-3 border border-gray-200 rounded lg:mr-24">
...
const Navbar = () => {
    return (
      <>
        <nav className = "p-4 flex bg-white w-full shadow-md items-center">
            <MobileNav />
            <MediumNav />
        </nav>
      </>
