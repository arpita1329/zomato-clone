        ...
        <>
            <div className="w-full h-64 relative px-4 overflow-hidden ">
                <div className="w-full h-full relative">
                    <img src="https://b.zmtcdn.com/data/pictures/2/18503752/a1cd82498e16a143ecda57f57cb353b3.jpg?output-format=webp" alt="food" className="w-full h-full rounded-lg object-cover transition duration-700 ease-in-out" />
                ...
                <div className="absolute w-full left-8 bottom-2 text-white">
                    ...
                    <h6 className="z-10 flex items-center">23 Places <IoMdArrowDropright /></h6>
                </div>
            </div>
        </>
    );
